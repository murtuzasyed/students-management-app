...
public class StudentIT {
    ...
    void canRegisterStudent() throws Exception {
        // given
        Student student = new Student(faker.name().firstName(), faker.name().lastName(), faker.internet().emailAddress(), Gender.MALE);
        // when
    ...
    void canDeleteStudent() throws Exception {
        ...
        Student student = new Student(faker.name().firstName(), faker.name().lastName(), faker.internet().emailAddress(), Gender.FEMALE);
        // Add a new student
